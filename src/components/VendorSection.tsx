      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-6 xl:col-span-7">
            <div className="mb-10">
              <h2 className="font-serif text-[2.25rem] lg:text-[2.75rem] font-semibold text-primary leading-[1.15] mb-5 tracking-[-0.01em]">
                Powered By Your<br />Trusted Newspaper<br />Vendor
              </h2>
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-8">
              {features.map((f, i) => (
                <div key={f.title} className="flex items-start gap-4 group">
                  <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-tan to-white flex items-center justify-center text-2xl shrink-0 border border-gold/20 shadow-sm group-hover:shadow-md transition-all duration-300 group-hover:-translate-y-0.5">
                    <div className="text-primary drop-shadow-sm">
                      {f.icon}
                    </div>
                  </div>
                  <div>
                    <div className="font-serif font-semibold text-primary text-[1.05rem] mb-0.5 group-hover:text-gold-mid transition-colors">{f.title}</div>
          ...
          <div className="lg:col-span-6 xl:col-span-5 flex justify-end">
            <div 
              className="overflow-hidden shadow-2xl border-[6px] border-white aspect-[4/5] relative w-full max-w-[420px]"
              style={{ borderRadius: "100px 20px 100px 20px", boxShadow: "0 24px 64px rgba(30,58,47,0.2), 0 0 0 1px rgba(198,156,109,0.2)" }}
            >
